...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'focus:ring-1disabled:cursor-not-allowed flex w-full items-center justify-between whitespace-nowrap rounded-md border bg-transparent text-sm shadow-sm disabled:opacity-50 [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >
