  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-stone-300',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-gray-300 tracking-wider bg-white  hover:bg-stone-100 transition-all text-gray-700 duration-300 hover:text-stone-900',
        secondary:
        ...
        primary:
          'bg-[#3ddfff] tracking-wider text-white shadow-sm hover:bg-[#3ddfff]/60 transition-all duration-300 dark:bg-stone-800 dark:text-stone-50 dark:hover:bg-stone-800/80',
        ghost:
      ...
      size: {
        ...
        sm: 'rounded-md px-8 h-12 text-sm',
        lg: 'h-12 w-full rounded-md px-8',
        icon: 'h-9 w-9',
      },
    },
    defaultVariants: {
