...
export default function UserDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        className="flex h-10 cursor-pointer items-center rounded-full bg-white/20 px-3 py-1 backdrop-blur-sm transition-all duration-300 hover:scale-105"
        onClick={toggleDropdown}
      >
        <Menu className="h-5 w-5 text-white" />
        <div className="mx-2 h-5 w-px bg-white" />
      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-6 w-80 overflow-hidden rounded-lg border bg-white shadow-lg duration-200 animate-in fade-in slide-in-from-top-5">
