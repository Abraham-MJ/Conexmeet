...
export async function GET(request: NextRequest) {
  try {
    ...
    const endpoint = `${baseUrl}/list-users-gender/female`;
    ...
    let responseDataFromApi: ApiExternalResponse;
    try {
      ...
      return NextResponse.json(
        {
          ...
          message:
            ...
            'Error al obtener el listado de usuarios desde la API externa.',
    ...
    console.error('Error en la API Route (list-female-users):', error);
